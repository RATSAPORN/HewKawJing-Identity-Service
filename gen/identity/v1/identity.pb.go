...
type TokenPair struct {
	...
	ExpiresIn     int64  `protobuf:"varint,4,opt,name=expires_in,json=expiresIn,proto3" json:"expires_in,omitempty"` // access token lifetime in seconds (3600)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RegisterRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	DisplayName   string                 `protobuf:"bytes,1,opt,name=display_name,json=displayName,proto3" json:"display_name,omitempty"` // 1-255 characters
	Email         string                 `protobuf:"bytes,2,opt,name=email,proto3" json:"email,omitempty"`                                // trimmed and lowercased by the server
	Password      string                 `protobuf:"bytes,3,opt,name=password,proto3" json:"password,omitempty"`                          // at least 8 characters, at most 72 UTF-8 bytes
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_identity_v1_identity_proto_rawDesc = "" +
	"\n" +
	"\x1aidentity/v1/identity.proto\x12\videntity.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\x93\x01\n" +
	"\x04User\x12\x17\n" +
	...
	"\x06tokens\x18\x02 \x01(\v2\x16.identity.v1.TokenPairR\x06tokens\":\n" +
	"\x13RefreshTokenRequest\x12#\n" +
	"\rrefresh_token\x18\x01 \x01(\tR\frefreshToken\"m\n" +
	"\x14RefreshTokenResponse\x12%\n" +
	"\x04user\x18\x01 \x01(\v2\x11.identity.v1.UserR\x04user\x12.\n" +
	"\x06tokens\x18\x02 \x01(\v2\x16.identity.v1.TokenPairR\x06tokens\"\x0e\n" +
	"\fGetMeRequest\"6\n" +
	"\rGetMeResponse\x12%\n" +
	"\x04user\x18\x01 \x01(\v2\x11.identity.v1.UserR\x04user\"\x0f\n" +
	"\rLogoutRequest\"\x10\n" +
	"\x0eLogoutResponse\"?\n" +
	"\x1aValidateAccessTokenRequest\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\"D\n" +
	"\x1bValidateAccessTokenResponse\x12%\n" +
	"\x04user\x18\x01 \x01(\v2\x11.identity.v1.UserR\x04user2\xf2\x02\n" +
	...
	"\fRefreshToken\x12 .identity.v1.RefreshTokenRequest\x1a!.identity.v1.RefreshTokenResponse\x12>\n" +
	"\x05GetMe\x12\x19.identity.v1.GetMeRequest\x1a\x1a.identity.v1.GetMeResponse\x12A\n" +
	"\x06Logout\x12\x1a.identity.v1.LogoutRequest\x1a\x1b.identity.v1.LogoutResponse2\x83\x01\n" +
	"\x17IdentityInternalService\x12h\n" +
	"\x13ValidateAccessToken\x12'.identity.v1.ValidateAccessTokenRequest\x1a(.identity.v1.ValidateAccessTokenResponseB,Z*identityService/gen/identity/v1;identityv1b\x06proto3"
...
var file_identity_v1_identity_proto_goTypes = []any{
	...
	(*LogoutResponse)(nil),              // 11: identity.v1.LogoutResponse
	(*ValidateAccessTokenRequest)(nil),  // 12: identity.v1.ValidateAccessTokenRequest
	(*ValidateAccessTokenResponse)(nil), // 13: identity.v1.ValidateAccessTokenResponse
	(*timestamppb.Timestamp)(nil),       // 14: google.protobuf.Timestamp
}
var file_identity_v1_identity_proto_depIdxs = []int32{
	14, // 0: identity.v1.User.created_at:type_name -> google.protobuf.Timestamp
	0,  // 1: identity.v1.RegisterResponse.user:type_name -> identity.v1.User
	0,  // 2: identity.v1.LoginResponse.user:type_name -> identity.v1.User
	1,  // 3: identity.v1.LoginResponse.tokens:type_name -> identity.v1.TokenPair
	0,  // 4: identity.v1.RefreshTokenResponse.user:type_name -> identity.v1.User
	1,  // 5: identity.v1.RefreshTokenResponse.tokens:type_name -> identity.v1.TokenPair
	0,  // 6: identity.v1.GetMeResponse.user:type_name -> identity.v1.User
	0,  // 7: identity.v1.ValidateAccessTokenResponse.user:type_name -> identity.v1.User
	2,  // 8: identity.v1.IdentityService.Register:input_type -> identity.v1.RegisterRequest
	4,  // 9: identity.v1.IdentityService.Login:input_type -> identity.v1.LoginRequest
	6,  // 10: identity.v1.IdentityService.RefreshToken:input_type -> identity.v1.RefreshTokenRequest
	8,  // 11: identity.v1.IdentityService.GetMe:input_type -> identity.v1.GetMeRequest
	10, // 12: identity.v1.IdentityService.Logout:input_type -> identity.v1.LogoutRequest
	12, // 13: identity.v1.IdentityInternalService.ValidateAccessToken:input_type -> identity.v1.ValidateAccessTokenRequest
	3,  // 14: identity.v1.IdentityService.Register:output_type -> identity.v1.RegisterResponse
	5,  // 15: identity.v1.IdentityService.Login:output_type -> identity.v1.LoginResponse
	7,  // 16: identity.v1.IdentityService.RefreshToken:output_type -> identity.v1.RefreshTokenResponse
	9,  // 17: identity.v1.IdentityService.GetMe:output_type -> identity.v1.GetMeResponse
	11, // 18: identity.v1.IdentityService.Logout:output_type -> identity.v1.LogoutResponse
	13, // 19: identity.v1.IdentityInternalService.ValidateAccessToken:output_type -> identity.v1.ValidateAccessTokenResponse
